...
jobs = [
    ...
    {"id": "1", "title": "Python Developer", "specialty": "backend", "company": "3", "salary_from": "100000",
    ...
    {"id": "2", "title": "Developer for Django project", "specialty": "backend", "company": "6", "salary_from": "80000",
    ...
    {"id": "5", "title": "Skilled Python Developer", "specialty": "backend", "company": "8", "salary_from": "120000",
...
companies = [
    ...
    {"id": "1", "title": "workiro", "logo": "logo1.png", "employee_count": "10", "location": "Liverpool", "description": "Разрабатываем мобильные приложения и сервисы для сферы онлайн-обучения."},
    {"id": "2", "title": "rebelrage", "logo": "logo2.png", "employee_count": "24", "location": "London", "description": "Мобильные сервисы, программное обеспечение, веб-сайты, мобильные приложения."},
    {"id": "3", "title": "staffingsmarter", "logo": "logo3.png", "employee_count": "123", "location": "London", "description": "Сервис онлайн-наблюдения за процессом сдачи экзамена с искусственным интеллектом"},
    {"id": "4", "title": "evilthreat h", "logo": "logo4.png", "employee_count": "36", "location": "London", "description": "Лидирующее в России и Восточной Европе ПО для проведения вебинаров и видео-конференций."},
    {"id": "5", "title": "hirey ", "logo": "logo5.png", "employee_count": "21", "location": "Bristol", "description": "Телекоммуникационные и платежные сервисы, которые помогают развиваться бизнесам во всем мире."},
    {"id": "6", "title": "swiftattack", "logo": "logo6.png", "employee_count": "79", "location": "London", "description": "Разработка сложных веб-сервисов и мобильных приложений"},
    {"id": "7", "title": "troller", "logo": "logo7.png", "employee_count": "230", "location": "Manchester", "description": "Мобильное приложение, позволяющее примерить обувь и выбрать идеальную пару всего в 3 клика"},
    {"id": "8", "title": "primalassault", "logo": "logo8.png","employee_count": "13", "location": "London", "description": "Реализуем проекты любой сложности в digital-сфере" }
